...
oo000 = Plugin ( )
ii = "plugin://plugin.video.salemmax.kenh108"
oOOo = 40
...
def IIi1IiiiI1Ii ( ) :
 ...
 if True:
  Oo = [
 { 'label' : 'Video gần đây Cập nhật' , 'path' : '%s/updated/%s/%s' % ( ii , urllib . quote_plus ( 'http://www.lsb-movies.net/kenh108/index.php?do=list&type=recently_updated&page=%s' ) , 1 ) } ,
 { 'label' : 'Video gần đây thêm' , 'path' : '%s/added/%s/%s' % ( ii , urllib . quote_plus ( 'http://www.lsb-movies.net/kenh108/index.php?do=list&type=more&page=%s' ) , 1 ) } ,
...
def iI ( url ) :
 ...
 iI11iiiI1II . create ( 'salemmax' , 'Loading video. Please wait...' )
