...
def xml_lists_menu():
    ...
    addDir("[B][COLOR lime]Danh sách tổng hợp một số kênh thể thao[/COLOR][/B]","http://hieuhien.vn/XBMC/P2PSTREAM/kenhchonloc.m3u",101,addonpath + art + 'itvsport.png',2,True)
    try:
