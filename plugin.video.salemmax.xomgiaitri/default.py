...
if 64 - 64: i11iIiiIii
OO0o = 'plugin.video.salemmax.xomgiaitri'
...
def ooO0OO000o ( ) :
 ...
 if True :
  OoOoOO00 ( 'Search' , 'http://www.xom60.com/xem/search/%s/1.html' , 'search' , 'http://blackbox247.com/images/Search.jpg' )
  OoOoOO00 ( 'Phim Lẻ' , 'http://www.xom60.com/xem/the-loai/phim-dien-anh' , 'index' , 'http://blackbox247.com/images/Movies.jpg' )
  OoOoOO00 ( 'Phim Bộ' , 'http://www.xom60.com/xem/the-loai/phim-bo' , 'index' , 'http://blackbox247.com/images/Series.jpg' )
  OoOoOO00 ( 'Phim Bộ theo Quốc Gia' , 'http://www.xom60.com/' , 'videosbyregion' , 'http://blackbox247.com/images/Regions.jpg' )
  OoOoOO00 ( 'Phim Lẻ theo Thể Loại' , 'http://www.xom60.com/' , 'videosbycategory' , 'http://blackbox247.com/images/Categories.jpg' )
 else :
  I11i = xbmcgui . Dialog ( )
...
def O0o0Oo ( url , name ) :
 ...
 for o0 , I11II1i in O00o0OO :
  iIi1ii1I1 ( "Part - " + I11II1i . replace ( "&nbsp;" , "" ) . strip ( ) . encode ( "utf-8" ) , "http://www.xom60.com/xem/" + o0 , 'loadvideo' , '' , name . encode ( "utf-8" ) )
...
def II1III ( k , e ) :
 ...
 for OooO0 in range ( len ( e ) ) :
  iIi11Ii1 = k [ OooO0 % len ( k ) ]
  Ii11iII1 = chr ( ( 256 + ord ( e [ OooO0 ] ) - ord ( iIi11Ii1 ) ) % 256 )
  iI1iI1I1i1I . append ( Ii11iII1 )
 return "" . join ( iI1iI1I1i1I )
 if 51 - 51: ii1IiI1i * iiI1i1 % II1i * ii1IiI1i % o00ooo0 / i1iIIIiI1I
def iIIIIii1 ( parameters ) :
 oo000OO00Oo = { }
 ...
 if parameters :
  ...
  for o000o in o0O0O00 :
   ...
   if ( len ( I11IiI1I11i1i ) ) == 2 :
    oo000OO00Oo [ I11IiI1I11i1i [ 0 ] ] = I11IiI1I11i1i [ 1 ]
 return oo000OO00Oo
 if 38 - 38: II1i
...
if IIi == 'index' :
 ...
 Iiii1i1 . create ( 'salemmax' , 'Loading video. Please wait...' )
 ooo ( oo , i1Iii1i1I )
 Iiii1i1 . close ( )
 del Iiii1i1
else :
