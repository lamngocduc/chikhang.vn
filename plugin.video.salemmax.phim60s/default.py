...
oo000 = Plugin ( )
ii = "plugin://plugin.video.salemmax.phim60s"
oOOo = 32
...
def II ( ) :
 ...
 if iI :
  iI11iiiI1II = "http://phim60s.info/tim-kiem/keyword/page-%s.html" . replace ( "keyword" , iI . replace ( " " , "+" ) )
...
def iiiIi1i1I ( url ) :
 ...
 oOO00oOO . create ( 'salemmax' , 'Loading video. Please wait...' )
...
def OoOo ( url ) :
 ...
 if "proxy.link=https://picasaweb.google.com/" in Oo0O :
  ii11i1 = re . compile ( 'proxy.link=(https://picasaweb.google.com/.+?)&amp;' ) . findall ( Oo0O ) [ 0 ]
  Oo0O = IIIii1II1II ( ii11i1 )
  Ooo0OO0oOO = re . compile ( ',\{"url"\:"(https://.+?)"\,"height"\:\d+\,"width"\:\d+\,"type"\:"video/mpeg4"\}' ) . findall ( Oo0O )
  OOO0OOO00oo = Ooo0OO0oOO [ 0 ]
  if oo000 . get_setting ( 'HQ' , bool ) and ( len ( Ooo0OO0oOO ) > 1 ) : OOO0OOO00oo = Ooo0OO0oOO [ 1 ]
 return OOO0OOO00oo
 if 42 - 42: Oo0o00o0Oo0 + Oo0oO0ooo
def i1IIi11111i ( url , page , route_name ) :
 o0O0o0Oo = int ( page ) + 1
 Oo0O = Ii11I ( url % page )
 Iii111II = re . compile ( '<img[^>]*src="(.+?)"></a><div class="info"><div class="name"><a title="(.+?)" href="(.+?)">' ) . findall ( Oo0O )
 iI1Ii11111iIi = [ ]
 for Ii11Ii1I , O00oO , I11i1I1I in Iii111II :
  Oo0o0 = { }
  Oo0o0 [ "label" ] = O00oO . strip ( )
  Oo0o0 [ "thumbnail" ] = Ii11Ii1I
  Oo0o0 [ "path" ] = '%s/%s/%s' % ( ii , "mirrors" , urllib . quote_plus ( "http://phim60s.info/" + I11i1I1I ) )
  iI1Ii11111iIi . append ( Oo0o0 )
 if len ( iI1Ii11111iIi ) == oOOo :
  iI1Ii11111iIi . append ( { 'label' : 'Next >>' , 'path' : '%s/%s/%s/%s' % ( ii , route_name , urllib . quote_plus ( url ) , o0O0o0Oo ) , 'thumbnail' : 'http://icons.iconarchive.com/icons/rafiqul-hassan/blogger/128/Arrow-Next-icon.png' } )
 return iI1Ii11111iIi
 if 83 - 83: o00 / iI1
def Ii1I ( murl ) :
 Oo0O = Ii11I ( murl )
 Iii111II = re . compile ( '(xem-phim/.+?/\d+.html)' ) . findall ( Oo0O )
 Oo0O = Ii11I ( 'http://phim60s.info/' + Iii111II [ 0 ] )
 iIIIIii1 = re . compile ( '<div class="server">.+?</ul></div>' ) . findall ( Oo0O )
 oo000OO00Oo = re . compile ( '<span itemprop="title" title="(.+?)">' ) . findall ( Oo0O ) [ 0 ]
 O0OOO0OOoO0O = [ ]
 for ii11i1iIII in iIIIIii1 :
  O00Oo000ooO0 = re . compile ( '<img[^>]*/>(.+?)</div>' ) . findall ( ii11i1iIII ) [ 0 ] . strip ( )
  OoO0O00 = [ ]
  for IIiII , o0 in re . compile ( '<a[^>]*href="(xem-phim/.+?/\d+.html)"[^>]*><b>(.+?)</b></a>' ) . findall ( ii11i1iIII ) :
   ii1I1i1I = { }
   ii1I1i1I [ "url" ] = 'http://phim60s.info/' + IIiII
   ii1I1i1I [ "name" ] = "Part %s - %s" % ( o0 , oo000OO00Oo )
...
def IIIii1II1II ( url ) :
 ...
 oO0o0OOOO = Oo0O . read ( )
 Oo0O . close ( )
 O0O0OoOO0 = { 'isslverify' : 'true' , 'iagent' : 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64; rv:30.0) Gecko/20100101 Firefox/30.0' , 'url' : url , 'ihttpheader' : 'true' }
...
O0oOO0 = xbmc . translatePath ( xbmcaddon . Addon ( 'plugin.video.salemmax.phim60s' ) . getAddonInfo ( 'profile' ) )
