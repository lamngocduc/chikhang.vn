...
oo000 = Plugin ( )
ii = "plugin://plugin.video.salemmax.phim14.net"
oOOo = 32
...
def iiI1 ( url ) :
 ...
 i11Iiii . create ( 'salemmax' , 'Loading video. Please wait...' )
...
I1i1III = xbmc . translatePath ( xbmcaddon . Addon ( 'plugin.video.salemmax.phim14.net' ) . getAddonInfo ( 'profile' ) )
